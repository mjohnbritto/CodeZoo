...
public class HomeController {
	...
	public static @ResponseBody String getRequiredDetailsForSignedInUser(HttpServletRequest request, HttpServletResponse response) throws JsonGenerationException, IOException{
